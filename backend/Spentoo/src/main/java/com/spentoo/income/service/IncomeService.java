...
public class IncomeService {
    ...
    @Transactional(readOnly = true)
    public List<IncomeDTO> listIncomesLastWeek(String userEmail) {
        User user = userRepository.findByEmailIgnoreCase(userEmail)
                .orElseThrow(() -> new IllegalStateException("User not found."));
        ...
        return incomeRepository.findAllByUserAndTransactionDateBetween(user, lastWeekStart, lastWeekEnd)
                .stream()
                .map(this::convertToDTO)
                .collect(Collectors.toList());
    }
    ...
    @Transactional(readOnly = true)
    public List<IncomeDTO> listIncomesLastMonth(String userEmail) {
        User user = userRepository.findByEmailIgnoreCase(userEmail)
                .orElseThrow(() -> new IllegalStateException("User not found."));
        ...
        return incomeRepository.findAllByUserAndTransactionDateBetween(user, lastMonthStart, lastMonthEnd)
                .stream()
                .map(this::convertToDTO)
                .collect(Collectors.toList());
    }
    ...
    @Transactional(readOnly = true)
    public List<IncomeDTO> listIncomesLastYear(String userEmail) {
        User user = userRepository.findByEmailIgnoreCase(userEmail)
                .orElseThrow(() -> new IllegalStateException("User not found."));
        ...
        return incomeRepository.findAllByUserAndTransactionDateBetween(user, lastYearStart, lastYearEnd)
                .stream()
                .map(this::convertToDTO)
                .collect(Collectors.toList());
    }
    ...
    @Transactional(readOnly = true)
    public List<IncomeDTO> listIncomesByDateRange(String userEmail, LocalDate startDate, LocalDate endDate) {
        User user = userRepository.findByEmailIgnoreCase(userEmail)
                .orElseThrow(() -> new IllegalStateException("User not found."));
        ...
        return incomeRepository.findAllByUserAndTransactionDateBetween(user, startDate, endDate)
                .stream()
                .map(this::convertToDTO)
                .collect(Collectors.toList());
    }
