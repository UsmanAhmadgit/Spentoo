...
@Data
@ToString(exclude = {"installments", "user"})
@EqualsAndHashCode(exclude = {"installments", "user"})
@Entity
@Table(name = "Loan")
public class Loan {
    ...
    @JsonIgnore
    private Set<LoanInstallment> installments = new HashSet<>(); // Initialize to empty set
